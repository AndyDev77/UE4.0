...
<body>
    ...
    <nav class="navbar navbar-expand-md fixed-top">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= ROOT_URL ?>actu.php">Actualités</a>
                </li>
                <li class="nav-item">
    ...
    <!--ImageBackground-->
    <section class="img-background" style="background-image: url('./images/apprentissages/_1010510.jpg');  background-size: cover; height: 80vh; min-height: 300px; position: relative; color: var(--white); text-shadow: var(--shadow-black-100); ">
