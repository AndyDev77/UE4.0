...
<body>
    ...
    <section class="img-background"
        style="background-image: url('./images/learning/_1010464.jpg');  background-size: cover; height: 80vh; min-height: 300px; position: relative; color: var(--white); text-shadow: var(--shadow-black-100); ">
      ...
      width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.4); ">
            <h1 style="font-size: 4rem;">LMS</h1>
        </div>
    </section>


    <section class="inscription section-padding" id="inscription">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-7">
                    ...
                    <div class="inscription-text">
                        <p>Système de gestion de l'apprentissage en ligne développé par le Training Center 4.0 pour
                            simplifier l'accès aux modules préparatoires au développement des compétences nécéssaires
                            aux métiers de la mécanique de précision.</p>
                        <br>
                    </div>
                    <div class="slider-btn">
                        <a href="#learning" class="btn btn-2 "><i class="fa fa-chevron-down" aria-hidden="true"></i></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-5 d-flex align-items-center justify-content-center">
                    <div class="inscription-img">
                        <img src="./images/inscriptions/TC2.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="learning section-padding" id="learning">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section-title">
                        <h2>Notre Learning Management System</h2>
                    </div>
                </div>
            </div>
            <br><br>
            <div class="row justify-content-center">
                <div class="lms-info">
                    ...
                    <div class="lms-text">
                        <p><i class="fas fa-check-circle"></i> Accès illimité aux modules (pendant la durée de l'inscription).</p>
                        <p><i class="fas fa-check-circle"></i> Accès aux simulateurs virtuels (A télécharger).</p>
                        <p><i class="fas fa-check-circle"></i> Accès aux formateurs experts métiers en ligne.</p>
                    </div>
                </div>
                <div class="lms-info">
                    <div class="lms-title">
                        <i class="fas fa-user-edit"></i>
                        <h4>Pour les tuteurs</h4>
                    </div>
                    <div class="lms-text">
                        <p><i class="fas fa-check-circle"></i> Conception des modules en fonction des besoins des industriels.</p>
                        <p><i class="fas fa-check-circle"></i>  Suivi personnalisé et individualisé des apprenants.</p>
                        <p><i class="fas fa-check-circle"></i> Réactivité et objectivité dans les accompagnements.</p>
                    </div>
                </div>
                <div class="lms-info">
                    <div class="lms-title">
                    ...
                    <div class="lms-text">
                        <p><i class="fas fa-check-circle"></i> Proposer des actions d'accompagnement renforcé en situation de travail.</p>
                        <p><i class="fas fa-check-circle"></i> Accès aux évaluations des compétences techniques.</p>
                        <p><i class="fas fa-check-circle"></i> Exprimer des besoins en production de modules spécifiques.</p>
                    </div>
                </div>
            </div>
        </div>
